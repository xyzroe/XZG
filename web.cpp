...
const char HTTP_HEADER[] PROGMEM =
  ...
  " </head>"
  "<body>"
  "<nav class='navbar navbar-expand-lg navbar-light bg-info rounded'><a class='navbar-brand' href='/'><img src='web/img/logo.png'/> <strong>Config </strong>"
  VERSION
  "</a>"
...
void handleTools() {
  ...
  result += F("<a href='/esp_update' class='btn btn-primary mb-2'>Update ESP32</button>");
  result += F("<a href='/updates' class='btn btn-primary mb-2'>Update Zigbee</button>");
